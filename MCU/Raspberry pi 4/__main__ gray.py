...
def main():
    ...
    while True:
        ...
        # 객체 탐지
        object_positions, object_classes = detect_object(gray_frame)
        
        # 화면에 프레임 표시
        resize_ratio = 0.5  # 크기를 조정할 비율 (0.5는 절반으로 크기를 줄임을 의미)
        resized_frame = cv2.resize(gray_frame, None, fx=resize_ratio, fy=resize_ratio, interpolation=cv2.INTER_AREA)
